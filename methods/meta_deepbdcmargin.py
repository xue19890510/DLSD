...
from .templatemargin import MetaTemplate
...
class MetaDeepBDC(MetaTemplate):
    ...
    def set_forward(self, x, is_feature=False):
        ...
        z_proto = F.normalize(z_proto,p=2,dim=-1, eps=1e-12)
        z_query = F.normalize(z_query,p=2,dim=-1, eps=1e-12)
    ...
    def set_forward_loss(self, x):
        ...
        scores = scores-0*one_hot(torch.from_numpy(y_label)).cuda()
